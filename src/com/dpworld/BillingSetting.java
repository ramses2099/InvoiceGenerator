...
public class BillingSetting {
    ...
    public BillingSetting() {
        try {
            ...
            this._file = new File(getClass().getResource("/connection/setting_billing.xml").toURI());
            ...
            System.out.println("BillingSetting : " + ex.getMessage());
        }
    }
    //
    public Credential getValue() {
        ...
        if (this._dict != null) {
            credential = this._dict.get("BILLING");
        }
        return credential;
    }
